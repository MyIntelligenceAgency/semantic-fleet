...

{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new SKException($"Something went wrong with Oobabooga Completion: {e.Message}", e);
        }
        finally
        {
...
#pragma warning restore CA2000 // Dispose objects before losing scope
    ...
    /// <summary>
    /// This method contains the logic to extract results from completion call responses.
    /// </summary>
