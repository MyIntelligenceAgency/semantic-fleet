...
public class OobaboogaTextCompletionSettings : OobaboogaCompletionSettings<OobaboogaCompletionParameters>
{
    ...
    public OobaboogaTextCompletionSettings(Uri? endpoint = default,
        ...
        ILoggerFactory? loggerFactory = null) : base(endpoint, blockingPort, streamingPort, concurrentSemaphore, useWebSocketsPooling, webSocketsCleanUpCancellationToken, keepAliveWebSocketsDuration, webSocketFactory, httpClient, loggerFactory)
    {
    }
}
