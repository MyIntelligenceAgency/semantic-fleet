...
def generate_report(self, analysis: Dict[str, Any]) -> Tuple[str, str]:
        ...
        with open(report_path, 'w', encoding='utf-8') as f:
            ...
            f.write("### Stratégies de Routage\n\n")
            
            f.write("#### Routage Basé sur la Complexité\n\n")
            f.write("| Niveau de complexité | Modèles recommandés |\n")
            f.write("|----------------------|---------------------|\n")
            
            for complexity, models in analysis['recommendations']['routingStrategies']['complexity'].items():
                f.write(f"| {complexity} | {', '.join(models)} |\n")
            
            f.write("\n#### Routage Basé sur le Type de Tâche\n\n")
            f.write("| Type de tâche | Modèles recommandés |\n")
            f.write("|---------------|---------------------|\n")
            
            for task_type, models in analysis['recommendations']['routingStrategies']['taskType'].items():
                f.write(f"| {task_type} | {', '.join(models)} |\n")
        ...
        final_report_path = os.path.join(os.path.dirname(os.path.dirname(self.output_dir)), 'results', 'final_analysis_report.md')
        ...
        with open(final_report_path, 'w', encoding='utf-8') as f:
            ...
            for strategy in analysis['recommendations']['fallbackStr
