...
New issues can be reported in our [list of issues](https://github.com/MyIntelligenceAgency/semantic-fleet/issues).
...
- **DON'T** commit code that you didn't write. If you find code that you think is a good
  fit to add to Semantic Fleet, file an issue and start a discussion before proceeding.
...
Contributions should maintain API signature and behavioral compatibility. Please file an issue to discuss
